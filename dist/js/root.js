...
(_a = document
    .getElementById("form__ship__button")) === null || _a === void 0 ? void 0 : _a.addEventListener("click", function (evt) {
    evt.preventDefault();
    validate();
});
(_b = document
    .getElementById("form__email__input")) === null || _b === void 0 ? void 0 : _b.addEventListener("change", function () {
    validateCSS(emailIsValid, this);
});
(_c = document
    .getElementById("form__phone__input")) === null || _c === void 0 ? void 0 : _c.addEventListener("change", function () {
...
(_d = document
    .getElementById("form__zip__input")) === null || _d === void 0 ? void 0 : _d.addEventListener("change", function () {
...
document
    ...
    if (this.options[this.selectedIndex].value === "United States of America") {
        ...
        if (FORMZIPINPUT.value.length > 0) {
